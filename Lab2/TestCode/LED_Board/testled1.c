...
while(1){
 PORTB = 0x00; //digit zero  on
  ...
  //PORTA = 0b11111110 ; //push button determines which segment is on
  //_delay_ms(200);
  //PORTA = 0b11111101 ; //push button determines which segment is on

  //_delay_ms(200);
  //PORTA = 0b11111011 ; //push button determines which segment is on

  //_delay_ms(200);
  //PORTA = 0b11110111 ; //push button determines which segment is on

  //_delay_ms(200);
  //PORTA = 0b11101111 ; //push button determines which segment is on

  //_delay_ms(200);
  //PORTA = 0b11011111 ; //push button determines which segment is on

  //_delay_ms(200);
  //PORTA = 0b10111111 ; //push button determines which segment is on
